...
The DataBox does have some support for an Internet proxies. It does NOT support transparent proxies or HTTPS proxies. But it does support a single HTTP proxy with either none or NTLM authentication.
